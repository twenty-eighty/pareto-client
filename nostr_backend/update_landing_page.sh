...
sed -i -e 's|https://pareto.onepage.me/de|/lp/de/index.html|g' -e 's|https://pareto.onepage.me/2|https://pareto.space|g' -e 's|pareto.onepage.me|pareto.space|g' -e 's|content="pareto.onepage.me"|content="The Pareto Project"|g' -e 's|lang="de"|lang="en"|g' $INDEX_EN

curl --compressed "$INDEX_OLD_DE" > $INDEX_DE

sed -i -e 's|https://pareto.onepage.me/2|/lp/en/index.html|g' -e 's|https://pareto.onepage.me/de|https://pareto.space|g' -e 's|pareto.onepage.me|pareto.space|g' -e 's|content="pareto.onepage.me"|content="The Pareto Project"|g' -e 's|lang="de"|lang="en"|g' $INDEX_DE
