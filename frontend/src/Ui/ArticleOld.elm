...
viewArticlePreview : BrowserEnv -> Styles msg -> Author -> Article -> Interactions -> Bool -> Html msg
viewArticlePreview browserEnv styles author article interactions displayAuthor =
    div
        [ css
            [ Tw.flex
            , Tw.items_center
