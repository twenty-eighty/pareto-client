        ...
        [ a
            ...
            , div
                ...
                [ div
                    ...
                    [-- Ui.Profile.viewProfileImageSmall (linkElementForAuthor picturePostViewData.author validationStatus) maybeProfile validationStatus
                     {-
                        a
                            [ Attr.href "/utxo"
                            , Attr.class "inactive"
                    ...
                    [ div
                        ...
                        , span
                            ...
                            [ div
                                ...
                                []
                            , text <| BrowserEnv.formatDate picturePostsViewData.browserEnv picturePost.createdAt
                            ]
                        ]
                    , div
