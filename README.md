...
- `IMAGE_CACHE_KEY`: Current HMAC key for the image caching server (also passed to the Elm client).
- `IMAGE_CACHE_KEY_PREVIOUS`: Previous HMAC key, accepted during rotation.
